...
//! consumer instead, so this crate stays free of reverse paths into `peppy`.
//!
...
pub use cargo::{
    build_target_triple, bundled_capnp_path, cargo_install_binary,
    cargo_install_binary_with_source_patch, embed_git_tag, find_bundled_capnp, peppy_shared_dir,
};
